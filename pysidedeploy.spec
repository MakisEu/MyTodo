...
# python path
python_path = .qtcreator/Python_3_13_7venv/bin/python3.13
...
modules = Concurrent,Core,DBus,Gui,Multimedia,Network,OpenGL,OpenGLWidgets,Sql,UiTools,Widgets,pyside6
