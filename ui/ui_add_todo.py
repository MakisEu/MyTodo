...
from PySide6.QtWidgets import (QApplication, QCheckBox, QComboBox, QDateTimeEdit,
    QFormLayout, QLabel, QPlainTextEdit, QPushButton,
    QSizePolicy, QWidget)
import rc_assets

class Ui_Add_Todo(object):
    def setupUi(self, Add_Todo):
        if not Add_Todo.objectName():
            Add_Todo.setObjectName(u"Add_Todo")
        Add_Todo.resize(392, 573)
        icon = QIcon()
        icon.addFile(u":/icons/assets/todo_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        Add_Todo.setWindowIcon(icon)
        Add_Todo.setAutoFillBackground(False)
        self.formLayoutWidget = QWidget(Add_Todo)
        ...
        self.formLayout.setWidget(4, QFormLayout.ItemRole.LabelRole, self.checkBox)

        self.pushButton_3 = QPushButton(self.formLayoutWidget)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setMinimumSize(QSize(160, 80))

        self.formLayout.setWidget(5, QFormLayout.ItemRole.LabelRole, self.pushButton_3)

        self.pushButton_4 = QPushButton(self.formLayoutWidget)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setMinimumSize(QSize(160, 80))

        self.formLayout.setWidget(5, QFormLayout.ItemRole.FieldRole, self.pushButton_4)


        self.retranslateUi(Add_Todo)

        QMetaObject.connectSlotsByName(Add_Todo)
    # setupUi

    def retranslateUi(self, Add_Todo):
        Add_Todo.setWindowTitle(QCoreApplication.translate("Add_Todo", u"Form", None))
        self.label_4.setText(QCoreApplication.translate("Add_Todo", u" Name:", None))
        self.label_5.setText(QCoreApplication.translate("Add_Todo", u"Start date:", None))
        self.dateTimeEdit_3.setDisplayFormat(QCoreApplication.translate("Add_Todo", u"dd/MM/yyyy hh:mm", None))
        self.label_6.setText(QCoreApplication.translate("Add_Todo", u"End date:", None))
        self.dateTimeEdit_4.setDisplayFormat(QCoreApplication.translate("Add_Todo", u"dd/MM/yyyy hh:mm", None))
        self.label_7.setText(QCoreApplication.translate("Add_Todo", u"Tag:", None))
        self.comboBoxTags.setItemText(0, QCoreApplication.translate("Add_Todo", u"None", None))
        self.comboBoxTags.setItemText(1, QCoreApplication.translate("Add_Todo", u"Productivity", None))
        self.comboBoxTags.setItemText(2, QCoreApplication.translate("Add_Todo", u"Education", None))
        self.comboBoxTags.setItemText(3, QCoreApplication.translate("Add_Todo", u"Work", None))
        self.comboBoxTags.setItemText(4, QCoreApplication.translate("Add_Todo", u"Entertainment", None))
        self.comboBoxTags.setItemText(5, QCoreApplication.translate("Add_Todo", u"Chore", None))

        self.checkBox.setText(QCoreApplication.translate("Add_Todo", u"Already Completed", None))
        self.pushButton_3.setText(QCoreApplication.translate("Add_Todo", u"Cancel", None))
        self.pushButton_4.setText(QCoreApplication.translate("Add_Todo", u"Create Todo", None))
    # retranslateUi
